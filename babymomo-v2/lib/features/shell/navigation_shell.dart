      ...
      bottomNavigationBar: Obx(() {
        return Container(
          decoration: BoxDecoration(
            color: MomoColors.surface.withOpacity(0.9),
            border: const Border(
          ...
          child: NavigationBar(
            ...
            indicatorColor: MomoColors.primary.withOpacity(0.2),
            selectedIndex: controller.currentIndex.value,
            onDestinationSelected: controller.changeTab,
            destinations: const [
              NavigationDestination(
                icon: Icon(Icons.spa_outlined, color: MomoColors.textSecondary),
                selectedIcon: Icon(Icons.spa, color: MomoColors.primary),
                label: 'Lounge',
              ),
              NavigationDestination(
                icon: Icon(Icons.chat_bubble_outline, color: MomoColors.textSecondary),
                selectedIcon: Icon(Icons.chat_bubble, color: MomoColors.primary),
                label: 'Chat',
              ),
              NavigationDestination(
                icon: Icon(Icons.brush_outlined, color: MomoColors.textSecondary),
                selectedIcon: Icon(Icons.brush, color: MomoColors.primary),
                label: 'Studio',
              ),
              NavigationDestination(
                icon: Icon(Icons.memory_outlined, color: MomoColors.textSecondary),
                selectedIcon: Icon(Icons.memory, color: MomoColors.primary),
                label: 'Hub',
              ),
            ],
          ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Spacer(),
            Obx(() => MomoMascot(mood: controller.mascotMood.value, size: 140)),
