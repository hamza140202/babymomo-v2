  ...
  void _initializeModelsList() {
    models.addAll([
      LocalModelUiModel(
        ...
        tierName: 'Fast',
        ramRequiredGB: 1.5,
        description: 'Sips battery, hyper-responsive, perfect for simple companion tasks.',
      ),
      LocalModelUiModel(
        id: 'momo_medium',
        name: 'Momo-Medium 3B',
        ...
        tierName: 'Balanced',
        ramRequiredGB: 3.5,
        description: 'Deeply empathetic, rich vocabulary, excellent conversation companion.',
      ),
      LocalModelUiModel(
        id: 'momo_large',
        name: 'Momo-Large 7B',
        ...
        ramRequiredGB: 6.0,
        description: 'Superb analytical capability, creative storytelling, long-term semantic memory.',
      ),
    ]);
  }
